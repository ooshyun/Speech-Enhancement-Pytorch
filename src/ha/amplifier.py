...
Audiogram example, which also includes in https://claritychallenge.org
------------------

'L0072': {'name': 'L0072', 
        'audiogram_cfs': [250, 500, 1000, 2000, 3000, 4000, 6000, 8000], 
        'audiogram_levels_l': [25, 40, 55, 65, 65, 70, 65, 60], 
        'audiogram_levels_r': [20, 30, 55, 65, 65, 75, 60, 50]}
...
class NALRTorch:
    def __init__(self, nfir: int, fs: int):
        ...
        self.aud = np.array([250, 500, 1000, 2000, 4000, 6000], dtype=np.float32)
